...
namespace DemoJira.Bussiness.APIServices
{
    public class TaskAPIService
    {
        ...
        private IterationDTO[] iterationDTOs;
        ...
        public async Task<IEnumerable<ProjectDTO>> GetAllProjectsAsync()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                projectDTOs = Newtonsoft.Json.JsonConvert.DeserializeObject<ProjectDTO[]>(result);
            }
            return projectDTOs;
        }
        ...
        public async Task<IEnumerable<IterationDTO>> GetAllIterations()
        {
            ...
            if(responseMessage.IsSuccessStatusCode)
            {
                ...
                iterationDTOs = Newtonsoft.Json.JsonConvert.DeserializeObject<IterationDTO[]>(res);
            }
        ...
        public async Task<ProjectDTO> GetProjByID(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                // Reading Response.    
                string result = await response.Content.ReadAsStringAsync();
                projectDTO   = Newtonsoft.Json.JsonConvert.DeserializeObject<ProjectDTO>(result);
            }
            return projectDTO;
